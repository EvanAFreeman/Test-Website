...
import moment from 'moment'; //lecture 106 moment.js
import { SingleDatePicker } from 'react-dates';
//lecture 105, regex101.com for regular expressions
    ...
    render() {
        return (
            <form className="form" onSubmit={this.onSubmit}>
                ...
                <SingleDatePicker //need to look at documentation for some of these
                ...
                className="textarea" value={this.state.note} onChange={this.onNoteChange}>
